...
use arch_common::com::{
    DEVMAN_PROC_NR, DS_PROC_NR, FB_PROC_NR, INIT_PROC_NR, MFS_PROC_NR, NET_PROC_NR, PFS_PROC_NR,
    PM_PROC_NR, RAMDISK_PROC_NR, RS_PROC_NR, SCHED_PROC_NR, TTY_PROC_NR, VFS_PROC_NR,
