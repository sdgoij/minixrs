...
fn main() {
    ...
    // Step 3: Generate a Rust source stub that includes the raw CPIO via include_bytes!
    // This is vastly faster than emitting a multi-megabyte array literal.
    ...
    let rs = format!(
        concat!(
            "// Auto-generated by tools/mkinitramfs.rs — DO NOT EDIT\n",
            "#[allow(dead_code)]\n",
            "#[allow(unused_attributes)]\n",
            "#[unsafe(link_section = \".initramfs\")]\n",
            "#[used]\n",
            "pub static INITRAMFS_CPIO: [u8; {}] = *include_bytes!(concat!(env!(\"CARGO_MANIFEST_DIR\"), \"/../../target/initramfs.cpio\"));\n",
            "pub const INITRAMFS_CPIO_LEN: usize = {};\n",
        ),
        cpio.len(),
        cpio.len(),
    );
